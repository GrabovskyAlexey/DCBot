...
class VerificationErrorDataRepository(
    ...
    override fun getData(user: User): VerificationErrorDto {
        ...
        return when(stateCode) {
            ADD_DRAADOR, SELL_DRAADOR, SET_SOURCE_PRICE, SEND_DRAADOR, RECEIVE_DRAADOR, ADD_VOID, REMOVE_VOID, ADD_CB, REMOVE_CB -> VerificationErrorDto("Введите положительное число")
